...
public:
    ...
    template<typename _Struct_>
    friend Client <_Struct_>& operator>> (Client <_Struct_>&, _Struct_&);

    template<typename _Struct_>
    friend Client <_Struct_>& operator<< (Client <_Struct_>&, _Struct_&&);

    template<typename _Struct_>
    friend Client <_Struct_>& operator<< (Client <_Struct_>&, const _Struct_&);

    template<typename _Struct_>
    friend Client <_Struct_>& operator<<(Client<_Struct_>&, std::string);

    template<typename _Struct_>
    friend Client <_Struct_>& operator>>(Client<_Struct_>&, typename Client<_Struct_>::info_pack_signal&);
